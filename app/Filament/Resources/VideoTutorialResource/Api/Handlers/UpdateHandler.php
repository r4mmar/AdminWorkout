...
use App\Filament\Resources\VideoTutorialResource\Api\Requests\UpdateVideoTutorialRequest;
...
class UpdateHandler extends Handlers {
     ...
     *
     * @param UpdateVideoTutorialRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(UpdateVideoTutorialRequest $request)
    {
        $id = $request->route('id');
